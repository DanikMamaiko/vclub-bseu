...
const SHEET_ID = "1uLyuqP1LsV0mImR62F7AUmwcTHYiJT-PgkFQbZt_Ns0";
const API_KEY = "AIzaSyBLJfAZN9c0u3yOah6geQCkb5u0shRbIYU";
const RANGE = "A1:E";
...
const translations = {
  ru: {
    "header.title": "Наше прошлое, настоящее и будушее",
    ...
    "submenu.faculty_title_main":
      'Сообщество выпускников экономического университета "Нархоз"',
    "header.subtitle": "Наше прошлое, настоящее и будушее",
  },
  be: {
    "header.title":
      "Мы робім разумных больш паспяховымі, а паспяховых — мудрэйшымі",
    ...
    "footer.address":
      "220070, г. Мінск, пр. Партызанскі 26, корпус 1, аўд. 1205",
  ...
  en: {
    "header.title":
      "We make the smart more successful, and the successful wiser",
...
const GRID_CONFIG = {
  ...
  desktop: [
    ...
    { type: "row", items: [{ type: "small", count: 3 }] },
    {
      type: "row",
      items: [
        { type: "small", count: 1 },
...
function toggleVersions() {
  ...
  document.querySelector(".mobile-version").style.display = isDesktop
    ? "none"
    : "block";
  document.querySelector(".desktop-version").style.display = isDesktop
    ? "block"
    : "none";
}
...
document
  .querySelector(".desktop-version .all-news-link")
  ?.addEventListener("click", () => {
    window.location.href = "allnews/";
  });

document
  .querySelector(".mobile-version .mobile-all-news")
  ?.addEventListener("click", () => {
    window.location.href = "allnews/";
  });
