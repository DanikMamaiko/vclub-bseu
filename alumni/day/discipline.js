const translations = {
  ...
  be: {
    ...
    "contacts.address":
      "220070, г. Мінск, пр. Партызанскі 26,<br>корпус 1, ауд. 1205",
    ...
    "footer.address":
      "220070, г. Мінск, пр. Партызанскі 26, корпус 1, ауд. 1205",
  ...
  en: {
    ...
    "contacts.address":
      "220070, Minsk, Partizansky Ave. 26,<br>building 1, room 1205",
    ...
    "disciplines.text1.part2":
      " specialty prepares specialists with knowledge and skills for the development, implementation, and use of information technologies in economics and business. The curriculum includes programming, design and operation of information systems, business process analysis and modeling, systems analysis, and business analytics. Students study corporate information systems, business analytics tools, decision support systems, as well as acquire skills in internet marketing, IT project management, and knowledge management. Special attention is paid to the economic efficiency of information systems and information security. The knowledge gained enables graduates to successfully solve tasks of business process automation, data analysis, and managerial decision-making in various economic sectors.",

    "disciplines.text2.part1": "The ",
    "disciplines.text2.bold": '"Applied Mathematics"',
    "disciplines.text2.part2":
      " specialty prepares specialists combining economic knowledge with advanced mathematical methods and IT tools. The focus is on economic-mathematical modeling, optimization methods, operations research, econometrics, and statistical analysis. Students master programming languages, databases, computer networks, study computer modeling of economic systems, data analysis, and information visualization. This allows graduates to successfully solve problems of analysis, forecasting, and management of economic systems.",

    "disciplines.text3.part1": "The ",
    "disciplines.text3.bold": '"Statistics"',
    "disciplines.text3.part2":
      " specialty prepares specialists with knowledge and skills for collecting, processing, analyzing, and interpreting data in various fields of economics and public life. The curriculum includes general statistics theory, economic and social statistics, statistics of activities, finance, prices, population, and other sectoral directions. Special attention is paid to statistical analysis of relationships, multivariate statistical methods, econometric modeling methods, processing and visualization of statistical data. Students study statistical information systems, SQL language, high-level programming languages, and business analytics tools. All this enables graduates to conduct comprehensive statistical research, identify patterns and trends, and develop forecasts and recommendations for managerial decision-making.",
    ...
    "footer.address":
      "220070, Minsk, Partizansky Ave. 26, building 1, room 1205",
  ...
  zh: {
    ...
    "disciplines.text1.part2":
      "专业培养具备在经济和商业领域开发、实施和使用信息技术知识与技能的专业人才。课程包括编程、信息系统设计与运行、业务流程分析与建模、系统分析和商业分析。学生学习企业信息系统、商业分析工具、决策支持系统，并掌握互联网营销、IT项目管理和知识管理技能。特别关注信息系统的经济效益和信息安全。所学知识使毕业生能够成功解决业务流程自动化、数据分析和管理决策等任务。",

    "disciplines.text2.part1": " ",
    "disciplines.text2.bold": "应用数学",
    "disciplines.text2.part2":
      "专业培养将经济学知识与先进数学方法和IT工具相结合的专业人才。重点是经济数学建模、优化方法、运筹学、计量经济学和统计分析。学生掌握编程语言、数据库、计算机网络，学习经济系统的计算机建模、数据分析和信息可视化。这使毕业生能够成功解决经济系统的分析、预测和管理问题。",

    "disciplines.text3.part1": " ",
    "disciplines.text3.bold": "统计学",
    "disciplines.text3.part2":
      "专业培养具备在经济和社会生活各领域收集、处理、分析和解释数据知识与技能的专业人才。课程包括统计学理论、经济和社会统计、活动统计、金融、价格、人口统计及其他行业方向。特别关注关系的统计分析、多元统计方法、计量经济学建模方法、统计数据处理和可视化。学生学习统计信息系统、SQL语言、高级编程语言及商业分析工具。这些知识使毕业生能够进行综合统计研究，识别规律和趋势，制定预测和管理决策建议。",
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const openBtn = document.getElementById("openDayForm");
  const modalOverlay = document.getElementById("dayFormModal");
  const modalClose = modalOverlay
    ? modalOverlay.querySelector(".modal-close")
    : null;
  const cancelBtn = document.getElementById("cancelDayFormBtn");
  ...
  if (form) {
    form.addEventListener("submit", (e) => {
      ...
      console.log("Alumni Day form submitted", data);
      alert("Спасибо! Ваши пожелания отправлены.");
      form.reset();
      closeModal();
    });
  }
