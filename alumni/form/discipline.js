const translations = {
  ru: {
    ...
    "disciplines.title": "Анкета выпускника",
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const openBtn = document.getElementById("openAlumniForm");
  const modalOverlay = document.getElementById("alumniFormModal");
  ...
  if (form) {
    form.addEventListener("submit", (e) => {
      ...
      if (!valid) {
        alert(
          "Пожалуйста, заполните обязательные поля и подтвердите согласие на обработку персональных данных."
        );
        return;
      }
